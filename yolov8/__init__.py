...
# results = model(source="human1.jpeg", show=True, conf=0.2, save=True)
# results = model(source="race3.jpg", show=True, conf=0.2, save=True)
# results = model(source="tokyo3.jpg", show=True, conf=0.2, save=True)
